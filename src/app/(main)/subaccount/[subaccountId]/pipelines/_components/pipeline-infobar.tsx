        ...
        >
          <PopoverTrigger asChild>
            <Button
              ...
              role="combobox"
              aria-expanded={open}
              aria-controls="pipeline-popover-content" // Added for accessibility
          ...
          <PopoverContent id="pipeline-popover-content" className="w-[200px] p-0">
            <Command>
            <CommandList>
              {pipelines.length === 0 && <CommandEmpty>No pipelines found.</CommandEmpty>}
              <CommandGroup>
