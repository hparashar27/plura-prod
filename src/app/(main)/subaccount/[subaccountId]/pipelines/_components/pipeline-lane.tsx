      ...
      {(provided, snapshot) => {
        ...
        return (
          ...
          >
            <AlertDialog>
              <DropdownMenu>
                <div className="bg-slate-200/30 dark:bg-background/20  h-[700px] w-[300px] px-4
                relative rounded-lg overflow-visible flex-shrink-0 ">
                  <div
                  ...
                  <Droppable
                    ...
                    type="ticket"
                  >
                     {/* overflow-scroll changed to overflow-hidden overflow-x-hidden */}
                    {(provided) => (
                      <div className=" max-h-[700px]  overflow-hidden overflow-x-hidden overflow-y-hidden pt-12 ">
                        <div
